            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6">
                {auctionDetailData ? (
                    <Tabs
                        defaultActiveKey="1"
                        className="w-full"
                        tabBarStyle={{ background: "#e6f4fa", padding: "8px", borderRadius: "8px" }}
                    >
                            ...
                            <div className="flex flex-col md:flex-row items-stretch mb-6">
                                ...
                                <div className="w-full md:w-2/3 pl-0 md:pl-4">
                                    ...
                                    <div className="space-y-2 bg-blue-50 p-4 rounded-lg">
                                        ...
                                        <div className="flex justify-between">
                                            <span className="font-medium text-blue-900">Thời điểm bắt đầu phiên đấu giá:</span>
                                            <span className="text-teal-800">
                                        ...
                                        <div className="flex justify-between">
                                            <span className="font-medium text-blue-900">Thời điểm kết thúc phiên đấu giá:</span>
                                            <span className="text-teal-800">
                                            ...
                                            >
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex justify-between">
                                                        <span className="font-medium text-blue-900">Tiền đặt trước:</span>
                                                        <span className="text-teal-800">
                                                            {asset.deposit ? `${parseFloat(asset.deposit).toLocaleString("vi-VN")} VND` : "-"}
                                                        </span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className="text-teal-700 text-right">{asset.description || "-"}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                        ...
                        <TabPane tab="Điều khoản tuân thủ" key="3">
                            <div className="p-4">
                                <h3 className="text-lg font-semibold text-blue-800 mb-2">Điều khoản tuân thủ</h3>
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    {auctionDetailData.auctionRules ? (
                                        <Typography.Link href={auctionDetailData.auctionRules} target="_blank" className="text-teal-600">
                    ...
                    <div className="text-center text-teal-600 py-6 bg-blue-50 rounded-lg">Đang tải dữ liệu...</div>
                )}
            </div>
        </section>
    );
