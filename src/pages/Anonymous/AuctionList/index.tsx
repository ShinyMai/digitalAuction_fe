...
const AuctionListAnonyMous = () => {
  ...
  const getListAuction = async () => {
    try {
      ...
      if (searchParams.RegisterOpenDate)
        params.RegisterOpenDate =
          searchParams.RegisterOpenDate;
      if (searchParams.RegisterEndDate)
        params.RegisterEndDate =
          searchParams.RegisterEndDate;
      if (searchParams.AuctionStartDate)
        params.AuctionStartDate =
          searchParams.AuctionStartDate;
      if (searchParams.AuctionEndDate)
        params.AuctionEndDate = searchParams.AuctionEndDate;
  ...
  return (
    <Layout className="bg-gradient-to-b from-blue-50 to-teal-50 min-h-screen">
      ...
      <Content className="p-4 md:p-8 min-h-screen">
        <Title
          level={2}
          className="text-center mb-6 text-3xl md:text-4xl text-blue-800"
        >
