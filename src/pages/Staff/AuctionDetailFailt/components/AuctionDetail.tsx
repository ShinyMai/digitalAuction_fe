      ...
      <div className="w-full mx-auto bg-white shadow-lg rounded-xl p-6">
        {auctionDetailData ? (
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-lg font-semibold text-blue-800 mb-4">Thông tin chủ tài sản</h3>
            ...
            {/* Thông tin bản đồ */}
            {auctionDetailData.auctionMap || auctionDetailData.auctionPlanningMap != 'No file uploaded' ? (
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-blue-800 mb-4">
