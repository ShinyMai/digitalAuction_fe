      ...
      <div className=" rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <span className="text-sm font-medium text-gray-500 min-w-[100px]">Trạng thái:</span>
        ...
        <div className="bg-white rounded-xl p-6 mb-6 border border-blue-100 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Tiêu đề bài viết</h3>
          </div>
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
            <h1 className="text-2xl font-bold text-gray-800 leading-relaxed">{blogData.title}</h1>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 mb-6 border border-green-100 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Hình ảnh đại diện</h3>
          </div>
          <div className="flex justify-center">
            <div className="relative rounded-xl overflow-hidden shadow-lg border border-gray-200">
              <Image
                ...
                fallback="data:image/png;base64,"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 mb-6 border border-purple-100 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Nội dung bài viết</h3>
          </div>
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
            <div className="prose max-w-none text-gray-700 leading-relaxed">
              {blogData.content.split("\n").map(
                (paragraph, index) =>
                  paragraph.trim() && (
                    <p key={index} className="mb-4 text-justify text-base leading-7">
                      {paragraph}
                    </p>
                  )
              )}
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
              ...
              <p className="text-gray-700 text-sm">{formatDate(blogData.createdAt)}</p>
            </div>
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
              <div className="flex items-center gap-2 mb-2">
                <CalendarOutlined className="text-green-500" />
                <span className="font-medium text-green-800">Ngày cập nhật</span>
              </div>
              <p className="text-gray-700 text-sm">{formatDate(blogData.updatedAt)}</p>
            </div>
          </div>
        </div>
