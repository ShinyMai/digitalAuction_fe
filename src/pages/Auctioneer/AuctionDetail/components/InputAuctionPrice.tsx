        ...
        <Col xs={24} md={8}>
          <div className="bg-white shadow-md rounded-lg p-6">
            <Form form={form} layout="vertical" onFinish={onFinish} className="w-full">
              <Row gutter={[16, 16]}>
                <Col xs={24}>
                  <Form.Item name="citizenIdentification" label="Citizen Identification">
                    <Input placeholder="Enter Citizen Identification" className="rounded-md" />
                  </Form.Item>
                </Col>
                <Col xs={24}>
                  <Form.Item name="auctionAssetId" label="Auction Asset ID">
                    <Input placeholder="Enter Auction Asset ID" className="rounded-md" />
                  </Form.Item>
                </Col>
                <Col xs={24}>
                  <Form.Item name="auctionAssetName" label="Auction Asset Name">
                    <Input placeholder="Enter Auction Asset Name" className="rounded-md" />
                  </Form.Item>
                </Col>
                <Col xs={24}>
                  <Form.Item
