          ...
          <Space direction="vertical" size="small" className="!w-full">
            <Space align="center" wrap>
              ...
              <div className="!ml-2 !text-sm !text-gray-500">
                {(() => {
                  const pm = (auctionRound as any)?.priceMin;
                  const px = (auctionRound as any)?.priceMax;
                  const tpm = (auctionRound as any)?.totalPriceMax;

                  const showPM =
                    typeof pm === "number" && Number.isFinite(pm) && pm > 0;
                  const showPX =
                    typeof px === "number" && Number.isFinite(px) && px > 0;
                  const showTPM =
                    typeof tpm === "number" && Number.isFinite(tpm) && tpm > 0;
                  ...
                  return (
                    <>
                      ...
                      {showTPM && (
                        <div className="text-sm text-emerald-600 mt-2 flex items-center gap-1 mb-4">
                          <span className="w-1 h-1 bg-emerald-500 rounded-full" />
