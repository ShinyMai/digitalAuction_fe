...
const items: MenuItem[] = [
  {
    ...
    label: "Thống kê",
    url: ROUTERCOMPANY.SUB.STATISTICS,
  ...
  },
  {
    ...
    url: ROUTERCOMPANY.SUB.AUCTION_LIST,
    roleView: ["Staff", "Auctioneer", "Director", "Manager", "Admin"]
  },
  {
    key: "3",
    icon: <ScheduleOutlined />,
    label: "Tạo buổi đấu giá",
    url: ROUTERCOMPANY.SUB.POST_AUCTION,
  ...
  },
  {
    ...
    url: ROUTERCOMPANY.SUB.DASHBOARD,
    roleView: ["Staff", "Admin"]
  },
  {
    key: "5",
    ...
    url: ROUTERCOMPANY.SUB.PROPERTIES,
...
const SiderRouteOption = () => {
  ...
  const filteredItems = items.filter((item) =>
    role && item.roleView.includes(role)
  );
  ...
  const getCurrentKey = () => {
    ...
    return currentItem ? currentItem.key : filteredItems[0]?.key || "1";
  };
